...
const translations: { [key: string]: string; } = {
  ...
  arenaContestProblemAdded: "Problem **%(problemAlias)** was **added**.",
  arenaContestProblemChangeLog: "Problem Change Log",
  arenaContestProblemModified: "Problem **%(problemAlias)** was **updated**.",
  arenaContestProblemModifiedRefresh: "Contest update: Problem \"%(problemAlias)\" has been updated. Please refresh the page.",
  arenaContestProblemRemoved: "Problem **%(problemAlias)** was **removed**.",
  arenaContestProblemUpdateAdded: "Contest update: Problem \"%(problemAlias)\" has been added to this contest.",
  arenaContestProblemUpdateRemoved: "Contest update: Problem \"%(problemAlias)\" has been removed from this contest.",
  ...
  cronControlPlaneHostInfo: "The machine that ran this job.",
  cronControlPlaneJobsHeading: "Jobs",
  cronControlPlaneLastRun: "Last run",
  cronControlPlaneLastStatus: "Last status",
  cronControlPlaneModelDataset: "Dataset size",
  cronControlPlaneModelHeading: "Recommendation model quality",
  cronControlPlaneModelNoRuns: "No training runs recorded yet",
  cronControlPlaneModelPublished: "Published",
  cronControlPlaneModelScore: "MAP score",
  cronControlPlaneModelScoreInfo: "How often the model suggested a problem the user actually solved next. Higher is better. A new model is only published if it clears the minimum and is not clearly worse than the last published one.",
  cronControlPlaneModelSkipReason: "Reason not published",
  cronControlPlaneName: "Name",
  cronControlPlaneNoJobs: "No jobs registered yet",
  cronControlPlaneNoPhases: "No phase detail",
  cronControlPlaneNoRuns: "No runs recorded yet",
  cronControlPlaneRerun: "Rerun",
  cronControlPlaneRerunQueued: "Rerun requested",
  cronControlPlaneRows: "Rows",
  cronControlPlaneRowsInfo: "How many rows the job wrote or updated.",
  cronControlPlaneRunsHeading: "Recent runs",
  cronControlPlaneSchedule: "Schedule",
  cronControlPlaneStarted: "Started",
  cronControlPlaneStatus: "Status",
  cronControlPlaneStep: "Step",
  cronControlPlaneStepsInfo: "The stages inside this run, with the time each one took.",
  cronControlPlaneSuccessRate: "Success rate",
  cronControlPlaneSuccessRateInfo: "Share of finished runs that succeeded.",
  ...
  navAlgorithmsBook: "Tutorial Book \"Problemas y Algoritmos\"",
  navAlgorithmsBookDesc: "By Luis Vargas",
  navAllCourses: "All courses",
  navAllProblems: "All problems",
  navAuthorRanking: "Contributors ranking",
  navBlog: "Blog",
  navBlogDesc: "Platform updates and articles",
  ...
  navCompetitiveProgrammingDataStructuresBook: "Competitive Programming Data Structures",
  navCompetitiveProgrammingDataStructuresBookDesc: "By Hugo Humberto Morales Pe\u00f1a",
  ...
  navDiscordDesc: "Chat with the community",
  navHelp: "Help",
  navKarel: "Karel.js",
  navKarelDesc: "Introductory programming environment",
  ...
  navOmegaUpIDEDesc: "Run and test code online",
  navProblemStatementEditor: "Problem Statement Editor",
  navProblemStatementEditorDesc: "Create and format problem statements",
  ...
  navTutorialsDesc: "Video guides for getting started",
  ...
  omegaupTitleAdminCrons: "Cron jobs",
  ...
  problemHealthCheckType: "Check",
  problemHealthDetail: "Detail",
  problemHealthHeading: "Problems needing attention",
  problemHealthNoFindings: "No problems need attention right now",
  problemHealthProblem: "Problem",
  problemHealthSeverity: "Severity",
  problemHealthSince: "Detected",
  ...
  teamsGroupArchiveConfirmText: "Are you sure you want to archive this team group?",
  teamsGroupArchivedSuccess: "Team group archived successfully.",
  ...
  teamsGroupShowArchived: "Show archived",
  ...
  teamsGroupUnarchiveConfirmText: "Are you sure you want to unarchive this team group?",
  teamsGroupUnarchivedSuccess: "Team group unarchived successfully.",
